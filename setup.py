"""
Setup module for the jupyterlab_ancun_file_browser proxy extension
"""
import setuptools
...
data_files_spec = [
    (
        ...
        "jupyterlab_ancun_file_browser.json",
    ),
]
...
setup_dict = dict(
    name="jupyterlab_ancun_file_browser",
    ...
    install_requires=["notebook", "boto3", "singleton-decorator"],
)
...
setuptools.setup(version="0.6.0", **setup_dict)
